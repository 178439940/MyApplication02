 ...
 */
public class SongSearchListViewAdapter extends BaseAdapter{
        ...
        public SongSearchListViewAdapter(Context c, List<SongBySearchBean> List, Callback call) {
        ...
        public View getView(final int position, View convertView,
            ...
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.song_search_item, null);
                viewHolder = new ViewHolder();
                viewHolder.song_name = (TextView) convertView
                        .findViewById(R.id.search_song_name);
                viewHolder.siner_name = (TextView) convertView
                        .findViewById(R.id.search_singer_name);
                viewHolder.download= (ImageButton) convertView
                        .findViewById(R.id.search_downloadbty);
            ...
            viewHolder.download.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    callback.downloadsongcallback(searchSongList.get(position).getSongid());
                }
            });
